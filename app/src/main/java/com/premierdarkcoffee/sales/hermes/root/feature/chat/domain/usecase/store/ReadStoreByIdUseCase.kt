...
class ReadStoreByIdUseCase @Inject constructor(private val storeRepository: StoreRepositoriable) {

    suspend operator fun invoke(storeId: String): StoreEntity? {
        return storeRepository.getUserById(storeId)
    }
}
